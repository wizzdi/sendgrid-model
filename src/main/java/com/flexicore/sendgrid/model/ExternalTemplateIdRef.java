...
@Entity
public class ExternalTemplateIdRef {
    ...
    public ExternalTemplateIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public ExternalTemplateIdRef(String id) {
        this.id = id;
    }
    ...
    public ExternalTemplateIdRef setFilterId(String filterId) {
    ...
    public ExternalTemplateIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
